...
pma_datasets = pd.read_csv("pma2020_datasets.csv")
pma_datafiles = pd.read_csv("pma2020_files.csv")
...
pma_datasets['dv.dsDescription'] = np.where(pma_datasets['dv.title'].str.contains("Service"), 
                                         '[{"dsDescriptionValue": "' + pma_datasets['dv.dsDescription'] + ' More information about this dataset can be found in the corresponding codebook, accessible at <a href=https://doi.org/10.34976/vfbp-bz42>https://doi.org/10.34976/vfbp-bz42</a>' + '"}]',
                                         '[{"dsDescriptionValue": "' + pma_datasets['dv.dsDescription'] + ' More information about this dataset can be found in the corresponding codebook, accessible at <a href=https://doi.org/10.34976/b88s-zx32>https://doi.org/10.34976/b88s-zx32</a>' + '"}]')

# Add link to codebook in related material 

pma_datasets['dv.relatedMaterial'] = ['["Codebook: <a href=https://doi.org/10.34976/vfbp-bz42>https://doi.org/10.34976/vfbp-bz42</a>"]' if 'Service Delivery Point' in x else '["Codebook: <a href=https://doi.org/10.34976/b88s-zx32>https://doi.org/10.34976/b88s-zx32</a>"]' for x in pma_datasets['dv.title']]
...
pma_datasets['dv.language'] = ['["English", "French"]' if any(s in x for s in ('Niger ', 'Ivoire', 'Democratic Republic of Congo', 'Burkina')) else '["English"]' for x in pma_datasets['dv.title']]
...
pma_datasets.to_csv("pma2020_datasets_toupload.csv", index=False)
...
pma_datafiles.to_csv("pma2020_files_toupload.csv", index=False)