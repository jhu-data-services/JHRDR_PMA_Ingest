...
pma_datasets = pd.read_csv("pmaet_codebook_datasets.csv")
pma_datafiles = pd.read_csv("pmaet_codebook_files.csv")
...
pma_datasets['dv.topicClassification'] = '[{"topicClassValue": "Maternal and Newborn Health"}]'
...
pma_datasets.to_csv("pmaet_codebook_datasets_toupload.csv", index=False)
...
pma_datafiles.to_csv("pmaet_codebook_files_toupload.csv", index=False)