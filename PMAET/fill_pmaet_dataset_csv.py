...
pma_datasets = pd.read_csv("pmaet_datasets.csv")
pma_datafiles = pd.read_csv("pmaet_files.csv")
...
pma_datasets['dv.dsDescription'] = np.where(pma_datasets['dv.title'].str.contains("Service"), 
                                         '[{"dsDescriptionValue": "' + pma_datasets['dv.dsDescription'] + ' More information about this dataset can be found in the corresponding codebook, accessible at <a href=https://doi.org/10.34976/xbrr-m897>https://doi.org/10.34976/xbrr-m897</a>' + '"}]',
                                         '[{"dsDescriptionValue": "' + pma_datasets['dv.dsDescription'] + ' More information about this dataset can be found in the corresponding codebook, accessible at <a href=https://doi.org/10.34976/zvvy-x402>https://doi.org/10.34976/zvvy-x402</a>' + '"}]')

# Add link to codebook in related material 

pma_datasets['dv.relatedMaterial'] = ['["Codebook: <a href=https://doi.org/10.34976/xbrr-m897>https://doi.org/10.34976/xbrr-m897</a>"]' if 'Service Delivery Point' in x else '["Codebook: <a href=https://doi.org/10.34976/zvvy-x402>https://doi.org/10.34976/zvvy-x402</a>"]' for x in pma_datasets['dv.title']]
...
pma_datasets['dv.topicClassification'] = ['[{"topicClassValue": "Maternal and Newborn Health"}]' if 'Panel' in x else '[{"topicClassValue": "Family Planning and Reproductive Health"}]' for x in pma_datasets['dv.title']]
...
pma_datasets.to_csv("pmaet_datasets_toupload.csv", index=False)
...
pma_datafiles.to_csv("pmaet_files_toupload.csv", index=False)